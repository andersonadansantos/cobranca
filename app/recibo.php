...
<body>
    <div class="recibo-topbar">
        <a href="dashboard.php"><i class="fas fa-arrow-left"></i> Faturas</a>
    ...
    <div class="recibo-wrap">
        ...
        <div class="recibo-note">
            Fatura <?= htmlspecialchars($recibo['fatura_numero']) ?> &middot; Para salvar o PDF, toque em "Baixar PDF" e escolha "Salvar como PDF".
        </div>
    </div>
</body>
</html>